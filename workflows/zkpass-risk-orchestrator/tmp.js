...
var init_errors = __esm(() => {
  BaseError2 = class BaseError22 extends Error {
    constructor(shortMessage, args = {}) {
      ...
      const docsPath2 = args.cause instanceof BaseError22 ? args.cause.docsPath || args.docsPath : args.docsPath;
      const message = [
        shortMessage || "An error occurred.",
        "",
        ...args.metaMessages ? [...args.metaMessages, ""] : [],
...
var init_abiItem = __esm(() => {
  init_errors();
  UnknownTypeError = class UnknownTypeError2 extends BaseError2 {
    constructor({ type }) {
      super("Unknown type.", {
        metaMessages: [
  ...
  UnknownSolidityTypeError = class UnknownSolidityTypeError2 extends BaseError2 {
    constructor({ type }) {
      super("Unknown type.", {
...
var init_abiParameter = __esm(() => {
  init_errors();
  InvalidParameterError = class InvalidParameterError2 extends BaseError2 {
    constructor({ param }) {
  ...
  SolidityProtectedKeywordError = class SolidityProtectedKeywordError2 extends BaseError2 {
  ...
  InvalidModifierError = class InvalidModifierError2 extends BaseError2 {
  ...
  InvalidFunctionModifierError = class InvalidFunctionModifierError2 extends BaseError2 {
    constructor({ param, type, modifier }) {
      super("Invalid ABI parameter.", {
        details: param,
        metaMessages: [
  ...
  InvalidAbiTypeParameterError = class InvalidAbiTypeParameterError2 extends BaseError2 {
...
var init_signature = __esm(() => {
  init_errors();
  InvalidSignatureError = class InvalidSignatureError2 extends BaseError2 {
  ...
  UnknownSignatureError = class UnknownSignatureError2 extends BaseError2 {
  ...
  InvalidStructSignatureError = class InvalidStructSignatureError2 extends BaseError2 {
    constructor({ signature }) {
...
var init_struct = __esm(() => {
  init_errors();
  CircularReferenceError = class CircularReferenceError2 extends BaseError2 {
    constructor({ type }) {
...
var init_splitParameters = __esm(() => {
  init_errors();
  InvalidParenthesisError = class InvalidParenthesisError2 extends BaseError2 {
...
function isSolidityType(type) {
  return type === "address" || type === "bool" || type === "function" || type === "string" || bytesRegex.test(type) || integerRegex2.test(type);
}
function isSolidityKeyword(name) {
  return name === "address" || name === "bool" || name === "function" || name === "string" || name === "tuple" || bytesRegex.test(name) || integerRegex2.test(name) || protectedKeywordsRegex.test(name);
}
...
function bytesToBase64(bytes) {
  ...
  for (;i2 + 2 < bytes.length; i2 += 3) {
    const n = bytes[i2] << 16 | bytes[i2 + 1] << 8 | bytes[i2 + 2];
  ...
  if (rem === 1) {
    ...
    const n = bytes[i2] << 16 | bytes[i2 + 1] << 8;
